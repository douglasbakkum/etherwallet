...
//      - Proper error message if receive no data (not plugged in; occupied by different device)
//      - Use translations for all dbb notifier messages (see successMsgs in globalFuncs.js and SUCCESS_ in tabsCtrl.js)
...
DigitalBitboxEth.parseError = function(errObject) {
    var errMsg = {
        err101: 'The Digital Bitbox is not initialized. First use the <a href="https://digitalbitbox.com/start">Digital Bitbox desktop app</a> to set up a wallet.',// No password set
        err250: 'The Digital Bitbox is not initialized. First use the <a href="https://digitalbitbox.com/start">Digital Bitbox desktop app</a> to set up a wallet.',// Wallet not seeded
